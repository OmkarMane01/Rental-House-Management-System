...
<br/ ><br/ ><br/ ><br/ ><br/ ><br/ ><br/ ><br/ ><br/ ><br/>
 ...
 <center><h3> <marquee behavior="alternate" scrollamount="8" width="1000"><font style="color:#FFFFFF;
  font-family:Courier New, Courier, monospace; font-size:30px;  ">
  <i>Here you must add  all information of your flat</i></font> 
</marquee></h3></center>
...
<div class="content">
    <h1 style="text-shadow:5px 5px 9px yellow;">ADD FLAT</h1> 
<center>     <p>
    <form action="addf.php" method="POST"  enctype="multipart/form-data"  >
      ...
      <h4> Firstname of Owner:<br/>     
         ...
         <center><input type="text" size="40" maxlength="40" name="lastnm" value="" /></center>
		     <br/>
          Name of City:  <br/>
        <center><input type="text" size="40" maxlength="40" name="city" value="" /></center>
        <br/>
         Area in City:<br/>
        <center> <input type="text" size="40" maxlength="40" name="area" value="" /></center>
      <br/>
	   Home Id:<br/>
        <center> <input type="text" size="40" maxlength="40" name="hid" value="" /></center>
        <br/>
		Full Address:<br/><center>
          <textarea name="address" cols="40"></textarea> </center>
       <br/>
	    Floor No:<br/>
        <center> <input type="text" size="40" maxlength="40" name="floorno" value="" /></center>
		<br/> Format of house:<br/><center>
		      <input name="subject" type="radio" value="1BHK"> 1BHK
             <input type="radio" name="subject" value="2BHK"> 2BHK
			 <input name="subject" type="radio" value="3BHK"> 3BHK
             <input type="radio" name="subject" value="4BHK"> 4BHK</center>
		<br/>
     ...
     Images of house:<br/><br/>
	  <center>
      <input type="file" name="uploadfile" value=""/> <br/><br/>
	    <input type="file" name="uploadfile" value=""/> <br/>
      </center>
	    Rent of Flat:<br/><center><input  type="text" size="40" maxlength="10" name="rent" value="" /></center>
       <br/>
