...
<br/ ><br/ ><br/ ><br/ ><br/ ><br/ ><br/ ><br/ ><br/ ><br/>
 <center><h3> <marquee behavior="alternate" scrollamount="8" width="1000"><font style="color:#FFFFFF; font-family:Courier New, Courier, monospace; font-size:30px;  "><i>Here you must add  all information of your house</i></font> 
</marquee></h3></center>
...
<div class="content">
    <h1 style="text-shadow:5px 5px 9px yellow;">ADD HOUSE</h1> 
<center>     <p>
    <form action="addh.php" method="POST"  enctype="multipart/form-data"  >
      ...
      <br/>
       ...
       <br/>
	      Format oh house:<br/><center><input name="subject" type="radio" value="1BHK"> 1BHK
     ...
     Description of House :<br/><center>
       <textarea name="descrip" cols="40"></textarea>
     </center>
   ...
   <br/>
      ...
      <input type="file" name="uploadfile" value=""/> <br/><br/>
	    ...
	    Rent of House:<br/><center><input  type="text" size="40" maxlength="10" name="rent" value="" /></center>
       <br/>
