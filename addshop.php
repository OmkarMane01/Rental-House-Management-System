...
<br/ ><br/ ><br/ ><br/ ><br/ ><br/ ><br/ ><br/ ><br/ ><br/>
 <center><h3> <marquee behavior="alternate" scrollamount="8" width="1000"><font style="color:#FFFFFF; font-family:Courier New, Courier, monospace; font-size:30px;  "><i>Here you must add  all information of your shop</i></font> 
</marquee></h3></center>
...
<div class="content">
    <h1 style="text-shadow:5px 5px 9px yellow;">ADD SHOP</h1> 
<center>     <p>
    <form action="adds.php" method="POST"  enctype="multipart/form-data"  >
      ...
      <h4> Firstname of Owner:<br/>     
         ...
         <center><input type="text" size="40" maxlength="40" name="lastnm" value="" /></center>
		     <br/>
          Name of Shop:  <br/>
        <center><input type="text" size="40" maxlength="50" name="shopnm" value="" /></center>
        <br/>
          Name of City:  <br/>
	  ...
	  Area in sqm:<br/><center> <input type="text" size="40" maxlength="6" name="areasqm" value=""  /></center>
        ...
        No of rooms in shop :<br/><center><input type="text" size="40" maxlength="6" name="noroom" value="" /></center>
       <br/>
     ...
     Description of Shop:<br/><center>
      ...
      <input type="file" name="uploadfile" value=""/> <br/><br/>
        ...
        Rent of shop :<br/><center><input  type="text" size="40" maxlength="10" name="rent" value="" /></center>
       <br/>
