...
<center><font color="#FFFFCC"><h1>Payment Option</h1></font></center>
 ...
 <div class="content">
	  <h1 style="text-shadow:5px 5px 9px yellow;">DEBIT CARD</h1> 
      <p>

<form action="debit2.php" method="POST"  enctype="multipart/form-data"  >
      

      <h4> AdharNo:<br/>     
         <center><input type="text" size="40" maxlength="16" name="adharno" value="" /></center>
		     <br/>
          CardNo:  <br/>
      ...
      <br/>
        Expire Date (yyyy-mm-dd):<br/><center>
         <input type="text" size="40" maxlength="50" name="expiredate" value="" /> </center>
       <br/>
	   Membership:<br/>
       <center>
