...
<marquee behavior="alternate" scrollamount="8" width="700">
       <font style="color:#FFFFFF; font-size:36px;  "><i>List of Godown</i></font> 
               </marquee>
</center>
...
$query="SELECT * FROM  `godown`  WHERE email =  '$useremail'";
...
{   while($result=mysqli_fetch_assoc($data))
   {
	   ...
	   '<font style="padding-left:10px;">'.$result['middlenm'].'</font>
	    ...
	    <font style="color:#FF9999">Godown Name:</font>'.$result['godownnm'].'<br/>
	     ...
	     <font style="color:#FF9999">City:</font>'.$result['city'] .'<br/>
		  ...
		  <font style="color:#FF9999">Desciption of Godown:</font>'.$result['desc'].'<br/>
