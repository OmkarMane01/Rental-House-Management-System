...
<marquee behavior="alternate" scrollamount="8" width="700">
       <font style="color:#FFFFFF; font-size:36px;  "><i>List of Houses</i></font> 
               </marquee>
</center>
<?php
  session_start();
...
$query="SELECT * FROM  `houselist`  WHERE email =  '$useremail'";
	   ...
	   '<font style="padding-left:10px;">'.$result['middlenm'].'</font>
        <font style="padding-left:10px;">'.$result['lastnm'].'</font><br/>
	     ...
	     <font style="color:#FF9999">City:</font>'.$result['city'] .'<br/>
		  ...
		  <font style="color:#FF9999">Desciption of house:</font>'.$result['descrip'].'<br/>
		  
		   <font style="color:#FF9999">Format of House:</font>' .$result['formatofhouse'] .'<br/>
